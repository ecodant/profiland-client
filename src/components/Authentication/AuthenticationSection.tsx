...
export default function AuthPage() {
  ...
  const { handleLoginSeller } = useSellers();
  ...
  const onLoginSubmit = async (data: LoginFormValues) => {
    try {
      setIsLoading(true);
      const seller = await handleLoginSeller(data);
      if (seller) {
        toast({
        ...
        <TabsContent value="login">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your ID/email and password to log in.
              </CardDescription>
            </CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between flex-row space-x-4">
                  <div className="space-y-2 w-3/5">
                    ...
                    <Input
                      id="personalId"
                      {...signUpForm.register("personalId")}
                    />
                    {signUpForm.formState.errors.personalId && (
                      <p className="text-sm text-red-500">
                        {signUpForm.formState.errors.personalId.message}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2 w-2/5">
                    ...
                    {signUpForm.formState.errors.license && (
                      <p className="text-sm text-red-500">
                        {signUpForm.formState.errors.license.message}
                      </p>
                    )}
                  </div>
                </div>
